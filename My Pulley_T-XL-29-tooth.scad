...
teeth = 29;			// Number of teeth, standard Mendel T5 belt = 8, gives Outside Diameter of 11.88mm
profile = 3;		// 1=MXL 2=40DP 3=XL 4=H 5=T2.5 6=T5 7=T10 8=AT5 9=HTD_3mm 10=HTD_5mm 11=HTD_8mm 12=GT2_2mm 13=GT2_3mm 14=GT2_5mm

Shaft_Style = 1;    // 0 = Rouns 1 = Hex
motor_shaft = 1;//15.2/2 ;	// NEMA17 motor shaft exact diameter = 5, FRC 1/2 Hex 15.2/2
...
retainer_ht = 4;	// height of retainer flange over pulley, standard = 1.5
...
//	translate ([0,0, pulley_b_ht + pulley_t_ht + retainer_ht ]) rotate ([0,180,0])
	...
	difference()
	 {	 
        ...
        translate([0, 0, 0])circle(motor_shaft,$fn=6);}
